...
export const createEmployeeSchema = z.object({
  ...
  personal_email: z.string().email('Enter a valid personal email'),
  ...
  guardian_phone: z.string().min(1, 'Guardian contact number is required'),
  guardian_email: z.string().email('Enter a valid guardian email').optional().or(z.literal('')),
